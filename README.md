...
2. [数组：每次遇到二分法，都是一看就会，一写就废](./problems/0704.二分查找.md)
    二分法的补充题目：https://leetcode-cn.com/problems/search-insert-position/solution/te-bie-hao-yong-de-er-fen-cha-fa-fa-mo-ban-python-/
...
字符串/数组/链表运算问题：
这几个题都差不多，用竖式思想来写，注意idx对于运算的影响即可。
* [415. 字符串相加]
* [2. 两数相加]
* [445. 两数相加 II]
* [369. 给单链表加一]
...
* [989. 数组形式的整数加法]
* [67. 二进制求和]
乘法有点不一样，需要累加在一起，然后再对这个累加之后的数组，从后往前进行进位。
* [43. 字符串相乘]
...
## 图论
* [797. 所有可能的路径](./problems/0797.所有可能的路径.md)
* [463.岛屿的周长](./problems/0463.岛屿的周长.md) （模拟）
* [841.钥匙和房间](./problems/0841.钥匙和房间.md) 【有向图】dfs，bfs都可以
* [127.单词接龙](./problems/0127.单词接龙.md) 广搜
* [拓扑排序: 207. 课程表](./problems/0207.课程表.md)
* [拓扑排序: 210. 课程表II](./problems/0210.课程表II.md)
* [二分图: 785. 判断二分图](./problems/0785_0886.判断二分图&可能的二分法.md)
* [二分图: 886. 可能的二分法](./problems/0785_0886.判断二分图&可能的二分法.md)

典中典岛屿问题收录: 200, 463, 695, 827
...
## 位运算
常用的位运算技巧：https://leetcode-cn.com/problems/power-of-two/solution/5chong-jie-fa-ni-ying-gai-bei-xia-de-wei-6x9m/

* [1356.根据数字二进制下1的数目排序](./problems/1356.根据数字二进制下1的数目排序.md) 
* [0136.只出现一次的数字](./problems/0136.只出现一次的数字.md) 

其他的很多位运算题都是看这俩题的评论区和题解写的， 傻了属于是。


## 博弈论
复习简单题的时候， 从三叶那题解找的几个。
看评论区老哥说了句典中典：
博弈论要么是先手必胜， 要么是后手有机会， 然后对于先手的决策进行状态转移， 最后看先手的净胜分是不是大于0的。
对于后手有机会赢的题，这有一个：
* [486. 预测赢家](./problems/486.预测赢家.md)

* [292. Nim 游戏](./problems/292.Nim游戏.md)
* [877. 石子游戏](./problems/877.石子游戏.md)
* [810. 黑板异或游戏](./problems/810.黑板异或游戏.md)
